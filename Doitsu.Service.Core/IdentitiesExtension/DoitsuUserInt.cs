...
namespace Doitsu.Service.Core.IdentitiesExtension
{
    public class DoitsuUserInt : IdentityUser<int>
    {
        ...
        public virtual async Task<TokenAuthorizeModel> AuthorizeAsync(UserManager<DoitsuUserInt> userManager, DoitsuUserInt user)
        {
        ...
        public virtual async Task<TokenAuthorizeModel> AuthorizeAsync(DoitsuUserIntManager userManager, DoitsuUserInt user)
        {
            var userRoles = (await userManager.GetRolesAsync(user));
        ...
        public virtual async Task<TokenAuthorizeModel> AuthorizeAsync(UserManager<DoitsuUser> userManager, DoitsuUser user)
        {
            var userRoles = (await userManager.GetRolesAsync(user));
            var claims = new List<Claim>
                {
